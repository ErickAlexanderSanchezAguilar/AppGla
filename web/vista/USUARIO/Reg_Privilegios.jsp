...
<html>
    ...
    <body>
        ...
        <form action="../../Privilegio"class="row"> 
            <center><label class="title"> Registrar Rol</label>
                <table class="table-responsive" >  
                    <tr>
                        <td>Modulo:</td>
                        <td >
                            <select class="col col-xs-1 select_modulo" name="modulo" required="">
                    ...
                    <tr><td>Estado Privilegio</td><td>
                            <select name="Es_privilegio" class="col col-xs-12" required="">
                                <option  value="1">Activado</option>
                                <option  value="0">Desactivado</option>
                            </select>
                        </td></tr>                           
                    <tr><td colspan="2"><button type="submit" class="btn btn-primary btn-block reg" value="REGISTRAR PRIVILEGIO"  name="opc">REGISTRAR PRIVILEGIO</button></td></tr>
                </table>
            </center>
        </form>
    </body>
