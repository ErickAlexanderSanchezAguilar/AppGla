...
<html>
    ...
    <body>
        <header>
            <h1 class="page-title text-center">Agregar Proveedores</h1>
        </header>
        <div class="well">
                ...
                $('.reg').click(function () {
                    ...
                    $.post("../../proveedor?opc=REGISTRAR", data, function () {
                        ...
                        $.smallBox({
                            ...
                            content: "<i class='fa fa-clock-o'></i> <i>El Proveedor ha sido registrado correctamente</i>",
                            color: "#659265",
                    ...
                    $.SmartMessageBox({
                        ...
                        if (ButtonPressed === "Si") {
                            $.post("../../Roles?opc=Modificar", "id_rol=" + idrol + "&Nombre_Rol=" + nrol + "&Es_rol=" + esrol, function () {
                                ...
                                $.smallBox({
                                    title: "Editar Proveedor",
                                    content: "<i class='fa fa-clock-o'></i> <i>El Proveedor ha sido modificado</i>",
                                    color: "#659265",
                                    iconSmall: "fa fa-check fa-2x fadeInRight animated",
                                    timeout: 2000
                                });
