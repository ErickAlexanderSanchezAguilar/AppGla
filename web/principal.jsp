<%
    ...
    String det_usuario = (String) sesion.getAttribute("ERICK") + " " + (String) sesion.getAttribute("AP_P") + " " + (String) sesion.getAttribute("AP_M");
%>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Principal.html"></a>
                </div>
                <!-- Top Menu Items -->
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> REGISTRO USUARIOS <i class="fa fa-fw fa-caret-down"></i></a>
                        ...
                        <li>
                            <a href="forms.html"><i class="fa fa-fw fa-edit"></i> Ingresar Datos</a>
                        </li>
                        <li>
