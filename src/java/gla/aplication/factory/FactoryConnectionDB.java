 ...
 */
package gla.aplication.factory;
...
public class FactoryConnectionDB {
    ...
    public static String[] configMYSQL = {"GLA_DISTRIBUIDORA", "root", "root"};
    ...
    public static String[] configORACLE = {"GLA_DISTRIBUIDORA", "gla", "localhost", "1521", "xe"};
